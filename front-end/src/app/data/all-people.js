const people = [
  ...
  },
  {
    ...
    job: "Assoc. Director Personal & Public Communication",
  ...
  },
  {
    ...
    description: ["Rob is an accomplished Director and a qualified accountant with a track record of delivering in complex environments whilst maintaining the highest standards. After a 16-year career with Royal Mail with advancement to the top from counter clerk to Director and NED, Rob turned his expertise to organisations ranging from start-ups to international brands such as Vodafone, DEFRA and Waitrose as well as being a trusted advisor to UK Government on multi-million pound projects.",
    "Rob has been successful in implementing strategy in an operational environment under high pressure whilst helping organisations to maximise their returns through right first time delivery as result of his considerable experience in a variety of sectors. He is a respected leader and is regularly invited into large scale programs that are failing and achieves results with instant impact.", "He has developed many teams that are beacons of best practice in their respective functions and has a wide network of experts to call upon if required."]
  },
  {
